    ...
    <div style="padding: 0 25px 25px;">
      ...
      <div style="background: rgba(5, 20, 40, 0.7); border-radius: 10px; padding: 20px; margin-top: 25px; border: 1px solid rgba(150, 225, 238, 0.2); box-shadow: 0 5px 15px rgba(0,0,0,0.3);">
        ...
        <div style="display: grid; grid-template-columns: 30px 1fr; gap: 12px; align-items: center;">
          ...
          <p style="margin: 0; color: white; font-size: 15px;"><strong>Date & Time:</strong> 20-23 April 2025 • 9AM to 5  PM</p>
      ...
      <div style="background: rgba(5, 20, 40, 0.7); border-radius: 10px; padding: 20px; margin-bottom: 25px; border: 1px solid rgba(150, 225, 238, 0.2);">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
          ...
          <div style="display: flex; justify-content: space-evenly; gap: 30px; margin-bottom: 15px;">
            <img src="https://acigalaxy.dz/wp-content/uploads/2024/04/LOGO-01-e1711972489493-2048x1531.png" alt="STREAM" style="max-width: 120px; max-height: 60px; object-fit: contain;">
            <img src="https://support.sav.streamsystem.com/Logo.png" alt="ACI GALAXY" style="max-width: 120px; max-height: 60px; object-fit: contain;">
          </div>
        </div>
